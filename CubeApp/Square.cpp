...
Square::Square(const D3DCOLOR& c)
	: currRot(0.f)
	, eyePos(0.f, 0.f, 2.f)
	, target(0.f, 0.f, 0.f)
	, up(0.f, 1.0f, 0.f)
	, color(c)
{
	...
	vertices[0] = VertexPosCol(-0.5f, 0.5f, 0.f, color);
	vertices[1] = VertexPosCol(-0.5f, -0.5f, 0.f, color);
	vertices[2] = VertexPosCol(0.5f, -0.5f, 0.f, color);
	vertices[3] = VertexPosCol(0.5f, 0.5f, 0.f, color);
